...
default_args={
    "owner": "Fran Parras,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-06-24", "YYYY-MM-DD").in_tz("GB"),
    catchup=False,
    owner_links={
        "Fran Parras": "mailto:franparras@boomi.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clxq1i3ll0o0r01ldnj8t1yji/cloud-ide/clxq1iq4k0nnf01otxyg7nhsd/clxq1iqf30nng01otfh105vqt",
    },
)
